...
== Αποτελέσματα
Παρουσιάζοντας τα Kops/sec για την κάθε περίπτωση κάθε και το κανονικοποιημένο Kops/sec δηλαδή ανά νήμα.
\
#align(center)[
=== Για μήκος λίστας 1024
\
#image("../a2_new/conc_ll/results/conc_ll_1024_100_0_0.png")
#image("../a2_new/conc_ll/results/conc_ll_1024_80_10_10.png")
#image("../a2_new/conc_ll/results/conc_ll_1024_20_40_40.png")
#image("../a2_new/conc_ll/results/conc_ll_1024_0_50_50.png")
\
\
#image("../a2_new/conc_ll/results/conc_ll_norm_1024_100_0_0.png")
#image("../a2_new/conc_ll/results/conc_ll_norm_1024_80_10_10.png")
#image("../a2_new/conc_ll/results/conc_ll_norm_1024_20_40_40.png")
#image("../a2_new/conc_ll/results/conc_ll_norm_1024_0_50_50.png")

=== Για μήκος λίστας 8192
#image("../a2_new/conc_ll/results/conc_ll_8192_100_0_0.png")
#image("../a2_new/conc_ll/results/conc_ll_8192_80_10_10.png")
#image("../a2_new/conc_ll/results/conc_ll_8192_20_40_40.png")
#image("../a2_new/conc_ll/results/conc_ll_8192_0_50_50.png")
\
\
#image("../a2_new/conc_ll/results/conc_ll_norm_8192_100_0_0.png")
#image("../a2_new/conc_ll/results/conc_ll_norm_8192_80_10_10.png")
#image("../a2_new/conc_ll/results/conc_ll_norm_8192_20_40_40.png")
#image("../a2_new/conc_ll/results/conc_ll_norm_8192_0_50_50.png")
\
]

Παρατηρούμε πως :
\
1)Στην περίπτωση που έχουμε μόνο contains ητν χειρότερη επίδοση την έχει η fine grain που έχει τεράστιο overhead καθώς έχει κλείδωμα για κάθε κόμβο, ενώ η coarse grain που έχει ένα global κλείδωμα τα πάει καλύτερα. 
\
...
\
\
#my_sourcefile("../a2_new/conc_ll/results/scraping_conc_ll.py")