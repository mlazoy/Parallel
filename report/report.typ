...
=== Σενάριο Σύγκλισης 
Για το σενάριο σύγκλισης δημιουργούμε τα 3 εκτελέσιμα περνώντας δυναμικά το DCONV Flag κατά την μεταγλώττιση και εξετάζουμε σταθερό μέγεθος πίνακα 512x512 με 64 MPI διεργασίες. Προκύπτουν τα παρακάτω διάγραμμα για τον χρόνο εκτέλεσης και επικοινωνίας. Ο χρόνος επικοινωνίας είναι με πιο αχνό χρώμα σε κάθε μπάρα.
\
