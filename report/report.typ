...
=== Σενάριο Σύγκλισης 
Για το σενάριο σύγκλισης εξετάζουμε όλες τις υλοποιήσεις για μέγεθος πίνακα 512x512 με 64 διεργασίες και κατασκευάζουμε το παρακάτω διάγραμμα για τον χρόνο εκτέλεσης και επικοινωνίας. Ο χρόνος επικοινωνίας είναι με πιο αχνό χρώμα σε κάθε μπάρα.
\
#align(center)[#image("../a4/heat_transfer/results/parlab/execution_time_methods_2.png",width:85%)]
\
...
=== Σενάριο σταθερού αριθμού επαναλήψεων Τ = 256
Για το σενάριο σταθερού αριθμού επαναλήψεων, απενεργοποιήθηκε ο έλεγχος σύγκλισης και έγιναν μετρήσεις για 1, 2, 4, 8, 16, 32, 64 διεργασίες και για μεγέθη πίνακα 2048x2048, 4096x4096, 6144x6144. Τα διαγράμματα επιτάχυνσης για κάθε μέγεθος πίνακα φαίνονται παρακάτω. Επισημαίνεται πως οι σειριακές μέθοδοι δεν είχαν τον ίδιο χρόνο εκτέλεσης για τους 3 αλγορίθμους.
\
#align(center)[
...
\
#align(center)[
  #image("../a4/heat_transfer/results/parlab/execution_time_breakdown_2048.png", width:85%)
  #image("../a4/heat_transfer/results/parlab/execution_time_breakdown_4096.png", width:85%)
  #image("../a4/heat_transfer/results/parlab/execution_time_breakdown_6144.png",width:85%)
...
== Παράρτημα
\
Για την δημιουργία των γραφικών παραστάσεων χρησιμοποίηθηκαν αρκετοί διαφορετικοί κώδικες σε Python. Ενδεικτικά για την σύγκριση των χρόνων εκτέλεσης όλων των υλοποιήσεων χρησιμοποιήθηκε ο παρακάτω κώδικας:
\
\
#my_sourcefile("../a4/heat_transfer/results/parlab/non_conv_total.py", lang:"python")
\