...
Aυξάνοντας παραπάνω το ποσοστό των add / delete η lazy χάνει σε throughput ενώ η optimistic κερδίζει στην περίπτωση του μικρού size=1024, ενώ δεν παρουσιάζει αισθητές διαφορές για μεγάλο size=8192.
