...
file_name = "../results/run_kmeans_5a.out"
with open(file_name, "r") as file:
    data1 = file.read()

file_name = "../results/run_kmeans_6a.out"
with open(file_name, "r") as file:
    data2 = file.read()
...
plt.grid()
plt.savefig("delta_reduction_coords_32_speedup.png")
plt.close()
...
y_max_limit = max_height + 10  # Adjust the padding value as needed
plt.ylim(0, y_max_limit)

# Save the plot
plt.tight_layout()
plt.savefig("delta_reduction_coords_32_comparison.png")
plt.close()